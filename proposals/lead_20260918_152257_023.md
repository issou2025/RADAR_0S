...
- The workspace's `onevcs` and `oneharness-core` requirements name the releases this
  task's cross-repository references name for those dependencies, and the lockfile
  resolves each to that release.
...
- The branch's history carries a closing reference naming
  ...
  routing closes it, and names the onevcs and oneharness issues the relink puts in force
  (154, 158, 1297, 1308) without closing them.
...
{"onepipeline.adoption":"published","onepipeline.consumes":{"oh-core":"core","ov-publish":"crate"},"onepipeline.execution_checkout":"nickderobertis__onepipeline","onepipeline.id":"op-relink-and-route","onepipeline.persona":"engineer","onetaskgraph.delivers":["followups:I_kwDOTx8aUc8AAAABR5zlNw"],"onetaskgraph.item_kind":"task"}
-->
