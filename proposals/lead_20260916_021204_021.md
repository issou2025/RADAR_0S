...
- The commit bodies carry a `Closes` line naming
  https://github.com/nickderobertis/onepipeline/issues/296.
...
every dispatch. The `Closes` line is the whole of what this node does about the issue.
...
{"onepipeline.execution_checkout":"nickderobertis__onepipeline","onepipeline.id":"op-stated-landing","onepipeline.persona":"engineer","onetaskgraph.item_kind":"task"}
-->
