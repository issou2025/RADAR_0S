...
The community is heavily focused on **improving extension and tool execution lifecycle**, with a major PR landing to apply tool changes mid-run (PR #6176). Several critical bugs around **streaming resilience** and **OpenAI API error handling** are being active
