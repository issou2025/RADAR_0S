...
**Ask Phil: evidence-backed EastEnders RAG demonstration — specification**
...
| Context assembly | Relevant context, required-fact coverage, sufficiency of combined evidence, and losses caused by truncation. |
...
- Implementation, source ingestion, labelled dataset construction, software tests, and model evaluations have not started. No performance, accuracy, or coverage results are claimed by this spec.
