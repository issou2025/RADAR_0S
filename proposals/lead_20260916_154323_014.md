...
- `onetaskgraph sources status-options <source>` reports the configured options the board lacks
  and makes no write.
- With `--apply` it sends every existing option with its id unchanged plus only the missing
  configured options, leaves unconfigured options present, and verifies afterwards that every
  pre-existing option id and every item's status assignment is unchanged.
...
{"onepipeline.id":"otg-1312","onepipeline.max_turns":200,"onepipeline.persona":"engineer","onetaskgraph.delivers":["followups:I_kwDOUBBgxs8AAAABRk0_GQ"],"onetaskgraph.item_kind":"task","orchestrator.plan-review":{"by":"planning-closeout","key":"7b4e4c269a7d4b6b6a96f4187d114367894b724c1db8b20ebda592cb28263624","reviewed_at":"2026-09-16T15:22:01.111546+00:00"}}
-->
