...
*Project description:*
**Entreprise** : Lemon.io  
**Poste** : Senior React Full-stack Developer  
**Localisation** : LATAM, Europe, USA, Canada, APAC · télétravail  
**Score** : 120 — asia\_relocation (apac) · stack +40 (.NET, Angular, AWS, C#, C++, Go, Java, JavaScript, Laravel, Next.js, Node.js, PHP, Python, React, Ruby, Rust, Scala, Spring, Svelte, Swift, Symfony, TypeScript, Vue)  
**Tech** : .NET, Angular, AWS, C#, C++, Go, Java, JavaScript, Laravel, Next.js, Node.js, PHP, Python, React, Ruby, Rust, Scala, Spring, Svelte, Swift, Symfony, TypeScript, Vue  
**Lien ATS** : [remotive.com](<https://remotive.com/remote-jobs/software-development/senior-react-full-stack-developer-2091101>)  
...
- Expertise in AWS, TypeScript and AI-assisted coding is a must.
...
<!-- jobradar:id=remotive:lemon-io:2091101 -->
