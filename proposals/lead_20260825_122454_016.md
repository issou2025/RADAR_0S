...
*Project description:*
<!-- task: .github/tasks/02-deepseek-single-shot-worker.md -->
@claude Add a single-shot DeepSeek worker workflow

Specification: [`.github/tasks/02-deepseek-single-shot-worker.md`](https://github.com/krybk/Accent/blob/6b9d35016343954979dc869106b516981784df24/.github/tasks/02-deepseek-single-shot-worker.md).
...
`Fixes #12` in the body. A branch without a pull request
